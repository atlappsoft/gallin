...
public class GLText {
   ...
   /**
    * Metodo que dibuja las etiquetas de la grafica GALLIN.
    */
   public void dibujaEtiquetas() {
      ...
      drawTexture(width, height, 0 );            // Draw the Entire Texture

      // TEST: render some strings with the font
      begin( 1.0f, 1.0f, 1.0f, 1.0f);         // Begin Text Rendering (Set Color WHITE)
      draw("Test String :)", 0, 0, 0 );          // Draw Test String
      draw( "Line 1", 50, 50, 0 );                // Draw Test String
      draw( "Line 2", 100, 100, 0 );              // Draw Test String
      end();                                   // End Text Rendering

      begin( 0.0f, 0.0f, 1.0f, 1.0f );         // Begin Text Rendering (Set Color BLUE)
      draw( "More Lines...", 50, 150, 0 );        // Draw Test String
      draw( "The End.", 50, 150 + getCharHeight(), 0 );  // Draw Test String
      end();                                   // End Text Rendering


      begin( 1.0f, 0.0f, 0.0f, 1.0f);         // Begin Text Rendering (Set Color RED)
      draw( "zoom out !", -200,0, -800 );        // Draw Test String
      draw( "zoom in !", -50,-50, 600 );        // Draw Test String
